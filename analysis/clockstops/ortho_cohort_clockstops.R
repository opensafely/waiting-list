...
# for all people with a closed RTT pathway for trauma/orthopaedic surgery
# (May21-May22)
###############################################################
...
# Save plot data 
write.csv(rtt_month, file = here::here("output", "clockstops", "rtt_dates_ortho.csv"),
          row.names = FALSE)
...
ggsave(here::here("output", "clockstops", "plot_rtt_dates_ortho.png"), plot1, dpi = 300,
       height = 4.5, width = 6)
...
# Save data for plot
write.csv(wait_time, file = here::here("output", "clockstops", "plot_wait_time_ortho.csv"),
          row.names = FALSE)
...
ggsave(here::here("output", "clockstops", "plot_wait_time_ortho.png"), plot2, dpi = 300,
       height = 3, width = 5)
...
write.csv(med_count_2, here::here("output", "clockstops", "med_counts_by_period_ortho.csv"),
          row.names = FALSE)
