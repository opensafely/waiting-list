...
## Load data ##
dat <- read_csv(here::here("output", "data", "cohort_ortho_openpathways.csv.gz"),
...
write.csv(exclude, here::here("output", "openpathways", "exclude_ortho.csv"),
          row.names = FALSE)
...
write.csv(categorical_dist, here::here("output", "openpathways", "cat_var_dist_ortho.csv"),
          row.names = FALSE)
